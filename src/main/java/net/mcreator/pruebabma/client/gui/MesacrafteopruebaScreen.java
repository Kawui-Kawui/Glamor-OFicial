...
import net.mcreator.pruebabma.network.MesacrafteopruebaButtonMessage;
import net.mcreator.pruebabma.PruebaBmaMod;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.systems.RenderSystem;

public class MesacrafteopruebaScreen extends AbstractContainerScreen<MesacrafteopruebaMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MesacrafteopruebaScreen(MesacrafteopruebaMenu container, Inventory inventory, Component text) {
