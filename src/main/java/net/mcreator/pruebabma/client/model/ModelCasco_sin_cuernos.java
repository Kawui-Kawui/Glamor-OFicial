...
public class ModelCasco_sin_cuernos<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("prueba_bma", "model_casco_sin_cuernos"),
			"main");
	public final ModelPart Helmet;

	public ModelCasco_sin_cuernos(ModelPart root) {
