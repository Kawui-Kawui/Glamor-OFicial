...
public class MesacrafteopruebaMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MesacrafteopruebaMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PruebaBmaModMenus.MESACRAFTEOPRUEBA, id);
